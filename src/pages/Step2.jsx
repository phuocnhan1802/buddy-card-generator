        ...
        <div className="flex flex-col gap-8">
          ...
          <Field label="I can help with">
            <textarea
              ...
              className="w-full rounded-sm border border-line px-4 py-2.5 text-sm focus:border-violet resize-none"
            />
          </Field>
          ...
          <div className="flex items-center gap-3">
            ...
            <Button onClick={handleDownload} loading={downloading} size="lg">
              Download Personal Card
            </Button>
            <Button variant="violet" onClick={() => setStep("step3")} className="ml-auto">
              Buddy Match →
            </Button>
          </div>
        </div>
      }
      previewPanel={<CardPreview ref={cardRef} user={user} />}
    />
  );
}
